...
export const laptops: Product[] = [
  {
    ...
    images: ["/images/laptops/fractal-pattern-laptop-essential-1.jpg"],
    specs: {
  ...
  },
  {
    ...
    images: ["/images/laptops/fractal-pattern-laptop-pro-1.jpg"],
    specs: {
      cpu: "8-core 3.2GHz",
      ramGb: 16,
      storageGb: 512,
  ...
  },
  {
    ...
    images: ["/images/laptops/fractal-pattern-laptop-elite-1.jpg"],
    specs: {
      cpu: "12-core 3.8GHz",
      ramGb: 32,
      storageGb: 1024,
